...
AmCharts.AmChart = AmCharts.Class({
	...
	updateWidth: function() {
		...
		if (d) {
			...
			0 > a && (a = 0),
			h.width = a + "px",
			"left" == d ? h.left = AmCharts.findPosX(this.div) +
			f + "px": e.left = a + "px",
			e.top = (b - g) / 2 + "px"
		}
		return a
	...
	handleResize: function() { (AmCharts.isPercents(this.width) || AmCharts.isPercents(this.height)) &&
		this.invalidateSize();
		this.renderFix()
	},
	renderFix: function() {
...
AmCharts.Cuboid = AmCharts.Class({
	...
	draw: function() {
		...
		1 > Math.abs(e) && (e = 0);
		1 > Math.abs(d) && (d = 0);
		b = 0 == e ? AmCharts.line(b, [0, d], [0, 0], k, l, j) : 0 == d ? AmCharts.line(b, [0, 0], [0, e], k, l, j) : 0 < p ? AmCharts.rect(b, d, e, h, i, j, k, l, p, o) : AmCharts.polygon(b, [0, 0, d, d, 0],
		[0, e, e, 0, 0], h, i, j, k, l, o);
...
AmCharts.AmLegend = AmCharts.Class({
	...
	drawLegend: function() {
		...
		a.translate(0, this.marginTop +
		this.verticalGap + this.ly + 1),
		a = a.getBBox(),
	...
	parseSerialData: function() {
		...
		if (d) {
			...
			for (var i = 0; i < d.length; i++) {
				...
				j.category = l;
				h[k[b]] = j;
				e && (l = new Date(l.getFullYear(), l.getMonth(), l.getDate(), l.getHours(), l.getMinutes(), l.getSeconds(), l.getMilliseconds()), l = AmCharts.resetDateToMin(l,
				g, f), j.category = l, j.time = l.getTime());
...
AmCharts.TrendLine = AmCharts.Class({
	...
	draw: function() {
		...
		i.categoryToCoordinate(k)), l && (f = i.dateToCoordinate(l)), o && (f = i.categoryToCoordinate(o)));
		m && !t && (isNaN(n) || (e = m.getCoordinate(n)), isNaN(q) || (f = m.getCoordinate(q)));
		p && !t && (isNaN(r) || (g = p.getCoordinate(r)), isNaN(s) || (h = p.getCoordinate(s))); ! isNaN(e) && (!isNaN(f) && !isNaN(g) && !isNaN(g)) && (b.rotate ? (i = [g, h], f = [e, f]) : (i = [e, f], f = [g, h]), g = a.lineColor, e = AmCharts.line(d, i, f, g, a.lineAlpha, a.lineThickness, a.dashLength), f = AmCharts.line(d, i, f, g, 0.005, 5), d = d.set([e, f]), d.translate(b.marginLeftReal, b.marginTopReal),
...
AmCharts.ValueAxis = AmCharts.Class({
		...
		if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
			...
			Infinity != this.min && -Infinity != this.max) {
				...
				for (e = m; e < n; e += p) if (m = this.step * e + this.min, m = AmCharts.roundTo(m, this.maxDecCount + 1), !(this.integersOnly && Math.round(m) != m)) { ! 0 == i && (0 == m && (m = this.minReal), 2 < q && (m = Math.pow(10, e)), s = -1 != ("" + m).indexOf("e") ? !0: !1);
					...
					s ? (u = -1 == ("" + m).indexOf("e") ? m.toExponential(15) :
					"" + m, u = u.split("e"), d = Number(u[0]), u = Number(u[1]), 10 == d && (d = 1, u += 1), u = d + "e" + u, 0 == m && (u = "0"), 1 == m && (u = "1")) : (i && (d = ("" + m).split("."), r.precision = d[1] ? d[1].length: -1), u = this.usePrefixes ? AmCharts.addPrefix(m, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, r) : AmCharts.formatNumber(m, r, r.precision));
			...
			a = this.labelsSet;
			this.positionTitle();
			"radar" != j ? (j = this.viX, f = this.viY, b.translate(j, f), a.translate(j, f)) : i.toFront(); ! this.visible || h ? (b.hide(),
	...
	stackGraphs: function(a) {
		...
		0; l < i.length; l++) if (h = i[l], !h.hidden && (k = h.type, h.chart == this.chart && (h.valueAxis == this && a == k && h.stackable) && (k = this.data[j].axes[this.id].graphs[h.id], h = k.values.value, !isNaN(h) && (g[j] = isNaN(g[j]) ? Math.abs(h) : g[j] + Math.abs(h), "regular" == b)))) {
			...
			"column" == a && !isNaN(h) && (k.values.close = h, 0 > h ? (k.values.close = h, isNaN(e[j]) ?
			k.values.open = o: (k.values.close += e[j], k.values.open = e[j]), e[j] = k.values.close) : (k.values.close = h, isNaN(f[j]) ? k.values.open = o: (k.values.close += f[j], k.values.open = f[j]), f[j] = k.values.close))
		}
		for (j = this.start; j <= this.end; j++) for (l = 0; l < i.length; l++) h = i[l],
		h.hidden || (k = h.type, h.chart == this.chart && (h.valueAxis == this && a == k && h.stackable) && (k = this.data[j].axes[this.id].graphs[h.id], h = k.values.value, isNaN(h) || (d = 100 * (h / g[j]), k.values.percents = d, k.values.total = g[j], "100%" == b && (isNaN(e[j]) && (e[j] = 0), isNaN(f[j]) &&
		(f[j] = 0), 0 > d ? (k.values.close = d + e[j], k.values.open = e[j], e[j] = k.values.close) : (k.values.close = d + f[j], k.values.open = f[j], f[j] = k.values.close)))))
	},
...
AmCharts.CategoryAxis = AmCharts.Class({
	...
	draw: function() {
		...
		if (AmCharts.ifArray(a)) {
			...
			if (this.parseDates && !this.equalSpacing) {
				...
				if (this.parseDates && this.equalSpacing) {
					...
					r = !1;
					for (this.end -
					this.start > this.gridCount && (r = !0); g < m; g++) if (n = this.data[g].time, this.checkPeriodChange(e, o, n, l)) {
			...
			for (g =
			0; g < this.data.length; g++) if (i = this.data[g]) j = this.parseDates && !this.equalSpacing ? Math.round((i.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(g - f),
			i.x[this.id] = j
		}
		...
		j.category && (m = b.getCategoryIndexByValue(j.category), isNaN(m) || (h = this.getCoordinate(m -
		f), m = (d - h) / 2, k = new this.axisItemRenderer(this, h, j.label, !0, NaN, m, j), this.pushAxisItem(k))),
		...
		j.date && (this.equalSpacing ? (m = b.getClosestIndex(this.data, "time", j.date.getTime(), !1, 0, this.data.length - 1), isNaN(m) || (h = this.getCoordinate(m -
		f))) : h = (j.date.getTime() - this.startTime) * this.stepWidth, m = (d - h) / 2, k = "H" == this.orientation ? new this.axisItemRenderer(this, h, j.label, !1, 2 * m, NaN, j) : new this.axisItemRenderer(this, h, j.label, !1, NaN, m, j), this.pushAxisItem(k)),
...
AmCharts.RecItem = AmCharts.Class({
	construct: function(a, b, d, e, f, g, h, i, j) {
		...
		ca = ga = 0;
		"V" == U && (D = 0);
		if (N) var R = AmCharts.text(p, d, o, k,
		l, L, i),
		ca = R.getBBox().width;
		if ("H" == U) {
			...
			if (0 <= b && b <= da + 1 && (0 < s && (0 < r &&
			b + j <= da + 1) && (ba = AmCharts.line(p, [0, s], [b + j, b + j], q, r, w), m.push(ba)), 0 < t)) L = AmCharts.line(p, [0, K, $ + K], [b, b + E, b + E], x, t, w, C),
			m.push(L);
			L = "end";
			...
			v += l / 2;
			"right" == J ? (B += K + $ + aa, v += E, I ? (B -= s + 4, g || (v -= l / 2 + 3)) : (B += s + 4 + n, v -= 2)) : I ? (B += s + 4 - aa, g || (v -= l / 2 + 3), h && (B += K, v += E)) : (B +=
			-s - n - 4 - 2 - aa, v -= 2);
...
AmCharts.RadItem = AmCharts.Class({
	construct: function(a, b, d, e, f, g, h) {
		...
		g = a.x,
		N = a.y;
		h ? (x = !0, isNaN(h.tickLength) || (m = h.tickLength),
		void 0 != h.lineColor && (r = h.lineColor), isNaN(h.lineAlpha) || (n = h.lineAlpha), isNaN(h.dashLength) || (s = h.dashLength), isNaN(h.lineThickness) || (q = h.lineThickness), !0 == h.inside && (C = !0)) : d || (n /= 3, m /= 2);
		var D = "end",
		T = -1;
		C && (D = "start", T = 1);
		if (x) {
...
AmCharts.AmGraph = AmCharts.Class({
	...
	createXYGraph: function() {
		...
		for (var f = this.start; f <= this.end; f++) {
			var g =
			this.data[f].axes[d.id].graphs[this.id],
			h = g.values,
			i = h.x,
			j = h.y,
			h = d.getCoordinate(i),
	...
	createSerialGraph: function() {
		...
		if (!T && ("line" == g || "smoothedLine" == g || "step" == g)) if (1 == d.length && ("step" != g && "none" == this.bullet) && (this.bullet = "round", this.resetBullet = !0), Ba || void 0 !=
		ua) {
			var va = E;
			va > f.max && (va = f.max);
			va < f.min && (va = f.min);
		...
		for (M = N; M <= D; M++) {
			...
			if (ma) {
				...
				case "smoothedLine":
					if (isNaN(O)) m ||
					(this.drawSmoothedGraph(n, q, ja, ka), n = [], q = [], ja = [], ka = []);
					else if (O < E && (v.isNegative = !0), n.push(z), q.push(y), V = z, W = y, qa = z, ra = y, Qa) ja.push(X),
					ka.push(S);
					break;
				case "step":
				...
				case "column":
					if (!isNaN(O)) {
						...
						if (! (O < hb && (ha < hb || void 0 == ha) || O > ib && ha > ib)) if (l) {
							...
							"3d" ==
							u ? (H = z - 0.5 * (h + L) + L / 2 + x * U, G = S + C * U) : (H = z - (o / 2 - U) * (h + L) + L / 2, G = S);
							F = h;
							V = H + h / 2;
							W = y;
							qa = H + h / 2;
				...
				case "candlestick":
					if (!isNaN(ha) && !isNaN(Sa) && !isNaN(Ra) && !isNaN(O)) {
						...
						Ua;
						O < ha && (v.isNegative =
						!0, Ba && (sa = Ba), Da && (Ea = Da), void 0 != ua && (Y = ua));
						if (l) {
				...
				!isNaN(O)) {
					...
					if (this.end - this.start <= lb || 0 == lb) {
						...
						if (this.labelText) {
							...
							case "middle":
								"column" ==
								g && (l ? (ta = -(z - X) / 2 - x, 0 > Z && (ta += x), Math.abs(z - X) < Ma && !this.showAllValueLabels && (fa.remove(), fa = null)) : (Aa = -(y - S) / 2, 0 > Z && (Aa -= C), Math.abs(y - S) < fb && !this.showAllValueLabels && (fa.remove(), fa = null)))
							}
	...
	drawLineGraph: function(a, b, d, e) {
		if (1 < a.length) {
			...
			q = this.baseCoord,
			r = AmCharts.line(g, a, b, this.lineColor,
			j, k, l, !1, !0);
			h.push(r);
			void 0 != p && (j = AmCharts.line(g, a, b, p, j, k, l, !1, !0), i.push(j));
			if (0 < f && (j = a.join(";").split(";"), k = b.join(";").split(";"), "serial" == this.chartType && (0 < d.length ? (d.reverse(), e.reverse(), j = a.concat(d), k = b.concat(e)) : this.rotate ? (k.push(k[k.length - 1]), j.push(q), k.push(k[0]), j.push(q), k.push(k[0]), j.push(j[0])) : (j.push(j[j.length - 1]), k.push(q), j.push(j[0]), k.push(q), j.push(a[0]), k.push(k[0]))), a = AmCharts.polygon(g, j, k, o, f, 0, 0, 0, this.gradientRotation), h.push(a), m || void 0 != p)) n || (n =
			f),
			m || (m = p),
	...
	animateGraphs: function() {
		...
		a = a.startEffect;
		b && (this.rotate ?
		(b.translate( - 1E3, f), d.translate( - 1E3, f)) : (b.translate(e, -1E3), d.translate(e, -1E3)), b.animate({
			opacity: 1,
			translate: e + "," + f
		},
		g, a), d.animate({
	...
	createBullet: function(a, b, d) {
		...
		"function" == typeof f ? (i = new f, i.chart = this.chart, a.bulletConfig && (i.availableSpace =
		d, i.graph = this, a.bulletConfig.minCoord = this.minCoord - d, i.bulletConfig = a.bulletConfig), i.write(e), i = i.set) : (this.chart.path && (f = this.chart.path + f), i = e.image(f, 0, 0, g, g).attr({
...
AmCharts.ChartCursor = AmCharts.Class({
	...
	createCursor: function() {
		...
		this.set.push(b);
		a ? (f && (h.pointerWidth = 0), "right" == e ? f ? h.setBounds(o, p + l, o + m + k, p + n + l) : h.setBounds(o + m + k + g, p + l, o + m + 1E3, p + n + l) : f ? h.setBounds(o, p, m + o, n + p) : h.setBounds( - 1E3, -1E3, o - q - g, p + n + 15)) : (h.maxWidth = m, d.parseDates &&
		(q = 0, h.pointerWidth = 0), "top" == e ? f ? h.setBounds(o + k, p + l, m + k + o, n + p) : h.setBounds(o + k, -1E3, m + k + o, p + l - q - g) : f ? h.setBounds(o, p, m + o, n + p - q) : h.setBounds(o, p + n + q + g - 1, o + m, p + n + q + g));
		this.hideCursor()
	},
		...
		if (this.enabled) {
			...
			if (d.mouseIsOver || u || A || this.forceShow) if (this.forceShow = !1, A) {
				...
				if (N && this.valueBalloonsEnabled && t && d.balloon.enabled) {
					...
					for (t = 0; t < N.length; t++) if (r = N[t], !(this.oneBalloonOnly && r != T) && (r.showBalloon && !r.hidden && r.balloonText) && (s = p.axes[r.valueAxis.id].graphs[r.id],
					w = s.y, !isNaN(w))) {
						i = s.x;
						m = !0;
						if (n) {
				...
				l.index = a, l.target =
				this, l.chart = this.chart, l.zooming = u, l.position = n ? f: e, l.target = this, d.fire("changed", l), this.fire("changed", l), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, d.updateLegendValues(a));
...
AmCharts.ChartScrollbar = AmCharts.Class({
	...
	init: function() {
		...
		a.axisRenderer = AmCharts.RecAxis, a.guideFillRenderer = AmCharts.RecFill, a.labelsEnabled = !1, a.chart = b), b = this.unselectedGraph, b || (b = new AmCharts.AmGraph, b.scrollbar = !0, this.unselectedGraph = b), b = this.selectedGraph, !b)) b = new AmCharts.AmGraph,
		b.scrollbar = !0,
...
AmCharts.wedge = function(a, b, d, e, f, g, h, i, j, k) {
	...
	var e = a.set(),
	A;
	p && (n = l(10 * n), r = l(10 * r), t = l(10 * t), x = l(10 * x), q = l(10 * q), s = l(10 *
	s), w = l(10 * w), m = l(10 * m), b = l(10 * b), j = l(10 * j), d = l(10 * d), g *= 10, h *= 10, i *= 10, o *= 10, 1 > Math.abs(f) && (1 >= Math.abs(t - r) && 1 >= Math.abs(w - s)) && (A = !0));
	if (0 < j) {
		var N;
		p ? (path = " M" + n + "," + (q + j) + " L" + r + "," + (s + j), A || (path += " A" + (b - g) + "," + (j + d - h) + "," + (b + g) + "," + (j + d + h) + "," + r + "," + (s + j) + "," + t + "," + (w + j)), path += " L" + x + "," + (m + j), 0 < i && (A || (path += " B" + (b - i) + "," + (j + d - o) + "," + (b + i) + "," + (j + d + o) + "," + x + "," + (j + m) + "," + n + "," + (j + q)))) : (path = " M" + n + "," + (q + j) + " L" + r + "," + (s + j), path += " A" + g + "," + h + ",0," + u + ",1," + t + "," + (w + j) + " L" + x + "," + (m + j),
		0 < i && (path += " A" + i + "," + o + ",0," + u + ",0," + n + "," + (q + j)));
		path += " Z";
	...
	p ? (A || (N = " A" + l(b - g) + "," + l(d - h) + "," + l(b + g) + "," + l(d + h) + "," + l(r) + "," + l(s) + "," + l(t) + "," + l(w)), g = " M" + l(n) + "," + l(q) + " L" +
	l(r) + "," + l(s) + N + " L" + l(x) + "," + l(m)) : g = " M" + n + "," + q + " L" + r + "," + s + (" A" + g + "," + h + ",0," + u + ",1," + t + "," + w) + " L" + x + "," + m;
...
AmCharts.AmPieChart = AmCharts.Class({
	...
	drawChart: function() {
		...
		if (AmCharts.ifArray(b)) {
			...
			p,
			m,
			n = AmCharts.toNumber(a.labelRadius),
			q = a.measureMaxLabel();
	...
	drawTicks: function() {
		for (var a = this.chartData, b = 0; b < a.length; b++) if (this.chartDataLabels[b]) {
			...
			e = d.ty,
			f = this.radiusReal,
			e = AmCharts.line(this.container, [this.pieXReal + d.ix * f, d.tx, d.tx2], [this.pieYReal +
	...
	arrangeLabels: function() {
		for (var a = this.chartData, b = a.length, d, e = b - 1; 0 <= e; e--) d = a[e],
	...
	checkOverlappingReal: function(a, b, d) {
		...
		d.width = f.width, d.height = f.height, d.y = a.ty,
		d.x = a.tx, a = g.getBBox(), g = {},
	...
	parseData: function() {
		...
		if (void 0 != b) {
			...
			1 < b && (this.groupValue =
			0, this.removeSmallSlices(), a.push({
...
AmCharts.AmXYChart = AmCharts.Class({
	...
	formatString: function(a, b) {
		...
		d || (d = this.numberFormatter);
		a = AmCharts.formatValue(a, b.values, ["value", "x", "y"], d); - 1 != a.indexOf("[[") &&
...
AmCharts.SVGRenderer = AmCharts.Class({
	...
	updateAnimations: function() {
		for (var a = this.animations.length - 1; 0 <= a; a--) {
			...
			if (e <= d) {
				...
				i = Number(i[1]),
				j = 0 ==
				j - g ? j: Math.round(this.D[b.effect](0, e, g, j - g, d)),
	...
	gradient: function(a, b, d, e) {
		...
		if (!isNaN(e)) {
			...
			k = 0;
			90 ==
			e ? j = 100: 270 == e ? k = 100: 180 == e ? h = 100: 0 == e && (i = 100);
			b.setAttribute("x1", h + "%");
			b.setAttribute("x2", i + "%");
			b.setAttribute("y1", j + "%");
			b.setAttribute("y2", k + "%")
